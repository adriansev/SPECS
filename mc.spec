...
Source0:	http://www.midnight-commander.org/downloads/mc-%{version}.tar.bz2
URL:		http://www.midnight-commander.org/
BuildRoot:	%{_tmppath}/%{name}-%{version}-%{release}-root-%(%{__id_u} -n)
BuildRequires:	glib2-devel e2fsprogs-devel slang-devel gpm-devel groff
BuildRequires:	aspell-devel libssh2-devel pcre-devel
Requires:	aspell aspell-ru aspell-en libssh2
...
%changelog
* Thu Dec 03 2013 Denis Frolov <d.frolov81@mail.ru> 4.8.11-1
- update to 4.8.11

* Mon Apr 08 2013 Denis Frolov <d.frolov81@mail.ru> 4.8.8-1
- update to 4.8.8

* Sat Dec 28 2012 Denis Frolov <d.frolov81@mail.ru> 4.8.7-1
- update to 4.8.7
...
* Mon Jul 23 2012 Jindrich Novy <jnovy@redhat.com> 4.8.4-2
